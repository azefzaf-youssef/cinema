...
@section('content')
    ...
    <div class="md-fab-wrapper">
        ...
        <x-heroicon-s-check-circle class="icon-style-btn-Large btn-primary-float  " id="post-edit-composant" data-url="{{route('USER-LOGGED-POST-EDIT-TRADUCTION-COMPOSANT-ILUSTRATION')}}" />
